...
int main(int argc, char ** argv) {
    ...
    llama_eval(ctx_tgt,  inp.data(), int(inp.size() - 1), 0, params.n_threads, params.use_dola);
    llama_eval(ctx_tgt, &inp.back(),      1, inp.size() - 1, params.n_threads, params.use_dola);
    llama_eval(ctx_dft,  inp.data(),     int(inp.size()), 0, params.n_threads, params.use_dola);
    ...
    while (true) {
        ...
        while (true) {
            ...
            llama_eval(ctx_dft, &id, 1, n_past_dft, params.n_threads, params.use_dola);
            ++n_past_dft;
        ...
        for (int i = 0; i < n_draft; ++i) {
            ...
            llama_eval(ctx_dft, &drafted.back(), 1, n_past_cur, params.n_threads, params.use_dola);
            ++n_past_cur;
        ...
        llama_eval(ctx_tgt, drafted.data(), drafted.size(), n_past_tgt, params.n_threads, params.use_dola);
        ++n_past_tgt;
